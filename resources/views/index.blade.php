<html>
  <head>
    ...
    <link rel="stylesheet" href="<?php echo asset('css/index2.css')?>" type="text/css">
  ...
  <div class="inicio">
          ...
          <div class="iniciooo">
              <form class="formu"  action="/onpoint" method="post">
                {{ csrf_field() }}
                @if (isset($msj))
                      <span>{{$msj}}</span>
                @endif
 ...
 <div class="mundo">
    <img src="../images/mundillo2.png" alt="">
 </div>
 </section>
 <footer>
